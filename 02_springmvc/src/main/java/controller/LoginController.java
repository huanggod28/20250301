...
//	@RequestMapping(value = "/login", method = {RequestMethod.GET})
	@GetMapping("/login")
	public String login(@RequestParam("username") String username, @RequestParam(value="password",required = false) String password) {
	...
	public String login(@PathVariable("u1") String username) {
		System.out.println("username :" + username);
		return "loginSuccess";
	}
	...
	public String loginModel(@RequestParam("username") String username, @RequestParam(value = "password2") String password, Model model) {
